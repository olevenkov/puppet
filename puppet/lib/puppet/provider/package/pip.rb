...
# TODO: Once we've moved to Puppet 2.7 this will no longer be needed.

require 'puppet/provider/package'
require 'xmlrpc/client'

Puppet::Type.type(:package).provide :pip, :parent => ::Puppet::Provider::Package do
  ...
  def self.instances
    packages = []
    pip_cmd = which('pip-python') or return []
